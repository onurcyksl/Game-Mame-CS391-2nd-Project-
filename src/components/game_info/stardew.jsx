...
class stardew extends Component {
  state = {};
  render() {
    return (
      <React.Fragment>
        <NavBar />
        <GameInfo
          title={this.getTitle("stardew")}
          publisher={this.getPublisher("stardew")}
          description={this.getDesc("stardew")}
          info={this.getInfo("stardew")}
          instructions={this.getInstructions("stardew")}
        />
        <Footer />
      </React.Fragment>
    );
